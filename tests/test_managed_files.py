...
def test_preserve_existing_envs_should_preserve_packaged_workflow_formatting() -> None:
    existing = """name: v1
...
"""
    new = """# Packaged workflow comment that should be retained
name: v2
on: # yamllint disable-line rule:truthy
  schedule:
    - cron: '0 6 * * 1,3,5'
...
def test_preserve_existing_triggers_should_preserve_packaged_workflow_formatting() -> None:
    existing = """name: v1
on:
  push:
    branches:
